    ...
    <div>
        ...
        <div className=" flex flex-col gap-4 relative p-4 py-16 pb-16 bg-cover bg-no-repeat bg-center">
          ...
          <div className="grid grid-cols-1 gap-y-2">
            <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2">
              ...
              <div className="lg:h-[150px] lg:w-[150px] mt-12 shadow-lg flex flex-col items-center justify-center rounded-lg bg-white">
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 lg:mr-16">
              <div className="lg:h-[150px] lg:w-[150px] shadow-lg flex flex-col items-center justify-center rounded-lg bg-white">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 gap-24 place-items-center">
          {info.map((item, index) => {
            return (
              <div
                key={index}
                className="p-6 rounded-lg flex flex-col gap-6 items-center h-[300px] w-[300px] bg-white shadow-2xl"
              >
      ...
      <section className="p-4 pb-16 grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 justify-around ">
        <div className="flex flex-col gap-4 px-8 ">
          ...
          <button
            className=" p-2 rounded-lg w-42 text-white mt-6"
            style={{ backgroundColor: "#FBDA7B" }}
          >
            {" "}
            استكشف المزيد{" "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-y-6">
          {infoThree.map((item, index) => {
            return (
              <div
                key={index}
                className="rounded-lg shadow-lg  flex flex-col gap-2 p-4 w-3/4 justify-around"
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 gap-24 place-items-center">
          {infoFour.map((item, index) => {
            return (
              <div
                key={index}
                className="p-6 rounded-lg flex flex-col gap-6 items-center h-[250px] w-[300px] bg-white shadow-2xl"
              >
                <Image src={item.image} className="size-16" />
                <h3 className="font-semibold text-lg text-center">
                  {item.name}
        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 gap-y-4 gap-x-2 place-items-center">
          {infoSix.map((item, index) => {
            return (
              <div
                key={index}
                className="p-6 rounded-lg lg:flex-row md:flex flex flex-col gap-4 items-center lg:h-[200px]   shadow-sm"
              >
